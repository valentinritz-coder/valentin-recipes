...
**Personnes** : 8 (ou 10–12 carrés en apéro)  
**Préparation** : 10 min  
**Cuisson** : 20–25 min  
**Matériel** : four, saladier, fouet/spatule, moule (idéal : poêle en fonte 24–26 cm ou plat), beurre
...
1. **Four + moule**
   ...
   - Si tu utilises une **poêle en fonte** : mets-la au four **5 min** pour la chauffer, puis ajoute **10–15 g de beurre** dedans (ça fait une croûte incroyable).
...
4. **Assembler**
   ...
   - Mélanger **juste** jusqu’à homogène (ne pas battre 2 heures, on ne fait pas une brioche).

5. **Cuisson**
   - Verser la pâte dans le moule chaud beurré.
   - Cuire **20–25 min à 200°C**.
   - C’est prêt quand c’est **doré**, et qu’un couteau ressort **sec**.

6. **Repos**
   - Laisser reposer **10 min** avant de couper (ça se tient mieux).
...
- **La veille** : oui, sans problème.
  ...
  - Réchauffage : **8–12 min à 160–170°C** (encore meilleur tiède).
- **Congélation** : en carrés, bien emballés. Réchauffage direct au four.

### Variantes (ranch assumé)
- **Cheddar + jalapeño** : +120 g cheddar râpé + 1 jalapeño haché.
- **Bacon** : +100 g de bacon/lardons déjà croustillants.
- **Herbes** : ciboulette/maïs/poivre, baisse un peu le sucre.
